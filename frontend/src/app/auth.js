                ...
                <div className="bg-[#181a1f]/80 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-8 shadow-2xl relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className={`grid gap-5 ${!isLogin ? 'md:grid-cols-2' : 'grid-cols-1'}`}>
                            <div className="space-y-2">
                                <label className="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-4">Contraseña de Acceso</label>
                                <div className="relative group">
                        ...
                        {error && (
                            <motion.div
                                ...
                                className={`text-xs p-4 rounded-xl text-center font-medium ${error.includes('exitoso') ? 'bg-green-500/10 text-green-400' : 'bg-red-500/10 text-red-400'}`}
                            >
                                {error}
                            </motion.div>
                        )}
                        ...
                        >
                            {isLoading ? (
                                ...
                                <>
                                    {isLogin ? 'Entrar a NexoBot' : 'Registrar Negocio'}
